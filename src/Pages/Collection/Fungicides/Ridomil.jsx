...
import ridomil from "../../../Components/BestFungicides/Ridomil.avif";
import ridomil2 from "./ridomil.webp";
      ...
      <div className="space-x-52 ml-12 mt-4 mb-4">
        <div className="flex text-sm gap-12 text-gray-500 font-secondary">
          <span className="space-x-2 ml-6">
            ...
            &gt;
            <span className="text-sm">Ridomil Syngenta</span>
          </span>
