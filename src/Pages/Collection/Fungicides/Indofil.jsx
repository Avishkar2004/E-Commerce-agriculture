...
import indofil2 from "./indofil.webp";
      ...
      <div className="space-x-52 ml-12 mt-4 mb-4">
        <div className="flex text-sm gap-12 text-gray-500 font-secondary">
          <span className="space-x-2 ml-6">
            ...
            &gt;
            <span className="text-sm">Indofil M - 45</span>
          </span>
          <a href="/fungicides/tatablitox" className=" ml-[59rem] font-secondary cursor-pointer hover:text-blue-500 text-base">
            Next &gt;
          </a>
        </div>
      </div>
