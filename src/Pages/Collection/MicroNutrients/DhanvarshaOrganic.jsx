...
import dhanvarsha from "../../../Components/micronutrientPhoto/DHANVARSHA_300x.avif";
import dhanvarsha2 from "./DHANVARSHA_500x.jpg";
    ...
    <div className="bg-gray-100 min-h-screen flex flex-col">
      <div className="space-x-52 ml-12 mt-4 mb-4">
        <div className="flex text-sm gap-12 text-gray-500 font-secondary">
          ...
          <a
            href="/micro-nutrients/chealacop"
...
export default DhanvarshaOrganic;
