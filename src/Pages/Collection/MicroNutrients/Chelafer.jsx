...
import chelafer from "../../../Components/micronutrientPhoto/Chelafer.avif";
import chelafer2 from "./chelafer.webp";
    ...
    <div className="bg-gray-100 min-h-screen flex flex-col">
      <div className="space-x-52 ml-12 mt-4 mb-4">
        <div className="flex text-sm gap-12 text-gray-500 font-secondary">
          ...
          &gt;<span className="text-sm">Chelafer </span>
          </span>
          <a
            href="/micro-nutrients/nutriclick"
            className=" ml-[62rem] font-secondary cursor-pointer hover:text-blue-500 text-base"
          >
            Next&gt;
          </a>
        </div>
