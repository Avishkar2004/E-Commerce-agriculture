...
import allwinGoldSuper2 from "./Allwingold_400x.webp";
      ...
      <div className="space-x-52 ml-12 mt-4 mb-4">
        <div className="flex text-sm gap-12 text-gray-500 font-secondary">
          <span className="space-x-2 ml-6">
            ...
            &gt;<span className="text-sm">Allwin Gold Super </span>
          </span>
          <a
            href="/micro-nutrients/agromingold"
...
export default AllwinGoldSuper;
