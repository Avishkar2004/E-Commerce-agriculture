...
import hamla2 from "./Hamla550_400x.webp";
      ...
      <div className="space-x-52 ml-12 mt-4 mb-4">
        <div className="flex text-sm gap-12 text-gray-500 font-secondary">
          <span className="space-x-2 ml-6">
            ...
            &gt;
            <span className="text-sm">Hamla 550</span>
          </span>
          <a href="/Insecticide/monocil" className="ml-[54rem] font-secondary cursor-pointer hover:text-blue-500 text-base">
            Next &gt;
          </a>
        </div>
      </div>
