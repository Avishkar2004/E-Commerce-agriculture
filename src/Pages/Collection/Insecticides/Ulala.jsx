...
import ulala2 from "./ulala_600x.jpg";
      ...
      <div className="space-x-52 ml-12 mt-4 mb-4">
        <div className="flex text-sm gap-12 text-gray-500 font-secondary">
          <span className="space-x-2 ml-6">
            ...
            &gt;
            <span className="text-sm">Ulala Insecticide</span>
          </span>
          <a href="/Insecticide/movento" className=" ml-[53rem] font-secondary cursor-pointer hover:text-blue-500 text-base">
            Next &gt;
          </a>
        </div>
      </div>
