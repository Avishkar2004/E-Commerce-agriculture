...
import activePlusOrganic from "../../../Components/OrganicProducts/ACTIVPLUS_200x.avif";
import activePlusOrganic2 from "./ACTIVPLUS_400x.webp";
      ...
      <div className="flex">
        ...
        <div className="w-1/2 bg-white text-center ml-12 border-r-2 border-l-2 border-t-2 border-b-2">
          <img
            ...
            src={activePlusOrganic}
            alt="Planofix pesticide"
          />
          <img
            src={activePlusOrganic2}
            alt="Planofix pesticide"
...
export default ActivePlusOrganic;
