...
import vermicompostOrganic from "../../../Components/OrganicProducts/Soil.webp";
import vermicompostOrganic2 from "./soil.webp";
      ...
      <div className="space-x-52 ml-12 mt-4 mb-4">
        <div className="flex text-sm gap-12 text-gray-500 font-secondary">
          <span className="space-x-2 ml-6">
            ...
            &gt;<span className="text-sm">Vermicompost</span>
          </span>
          <a
      ...
      <div className="flex">
        ...
        <div className="w-1/2 bg-white text-center ml-12 border-r-2 border-l-2 border-t-2 border-b-2">
          <img
            ...
            src={vermicompostOrganic}
            alt="Planofix pesticide"
          />
          <img
            src={vermicompostOrganic2}
            alt="Planofix pesticide"
...
export default VermicompostOrganic;
