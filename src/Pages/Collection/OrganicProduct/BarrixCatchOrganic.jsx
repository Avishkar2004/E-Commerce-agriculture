...
import barrixCatchOrganic from "../../../Components/OrganicProducts/Barrix catch.avif";
import barrixCatchOrganic2 from "./barrix-catch-vegetable-fly-trap_250x.jpeg";
      ...
      <div className="space-x-52 ml-12 mt-4 mb-4">
        <div className="flex text-sm gap-12 text-gray-500 font-secondary">
          <span className="space-x-2 ml-6">
            ...
            >
            <a className="hover:text-blue-500 text-sm">Barrix Catch Vega... </a>
            >
          </span>
          <a
            href="/OrganicProduct/tatabahar"
            className=" ml-[55rem] pl-14 font-secondary cursor-pointer hover:text-blue-500 text-base"
          >
            Next >
          </a>
        </div>
      ...
      <div className="flex">
        ...
        <div className="w-1/2 bg-white text-center ml-12 border-r-2 border-l-2 border-t-2 border-b-2">
          <img
            ...
            src={barrixCatchOrganic}
            alt="Planofix pesticide"
          />
          <img
            src={barrixCatchOrganic2}
            alt="Planofix pesticide"
...
export default BarrixCatchOrganic;
