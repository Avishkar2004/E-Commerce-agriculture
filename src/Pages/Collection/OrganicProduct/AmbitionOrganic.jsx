...
import ambitionOrganic from "../../../Components/OrganicProducts/AMBITION.avif";
import ambitionOrganic2 from "./ambition.webp";
      ...
      <div className="space-x-52 ml-12 mt-4 mb-4">
        <div className="flex text-sm gap-12 text-gray-500 font-secondary">
          <span className="space-x-2 ml-6">
            ...
            &gt;
            <span className="text-sm">AMBITION (Crop Supplement)</span>
          </span>
          <a
            href="/OrganicProduct/barrixcatch"
            className=" ml-[56rem] font-secondary cursor-pointer hover:text-blue-500 text-base"
          >
            Next &gt;
...
export default AmbitionOrganic;
